...
class MeasureWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool start_isActive =
        (state == 'PAUSED' || state == 'STOPPED') ? true : false;
    final start_icon = Container(
    ...
    bool stop_isActive =
        (state == 'PAUSED' || state == 'RUNNING') ? true : false;
    final stop_icon = Container(
      decoration: BoxDecoration(shape: BoxShape.circle, color: Colors.white),
      child: IconButton(
          iconSize: 100,
          icon: Icon(
